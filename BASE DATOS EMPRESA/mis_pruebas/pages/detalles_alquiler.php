...
<div class = "bloque-movimiento"> 
    ...
    <div class = "contenedor-tablas">
        <?php $totalAmpliaciones = $alquiler->getprecio(); //ampliaciones se inicia con el precio del alquiler y va sumando precio de ampliaciones. no se puede usar $alquiler->getsumaPrecio() porque en el select que le este alquiler no se agrupan el precio de ampliaciones
