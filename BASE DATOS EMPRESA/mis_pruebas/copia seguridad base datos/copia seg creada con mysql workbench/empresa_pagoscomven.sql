...
CREATE TABLE `pagoscomven` (
  ...
  PRIMARY KEY (`idPago`),
  KEY `fk_pagador_idx` (`pagador`) /*!80000 INVISIBLE */,
  KEY `fk_compraventa` (`compraventa`) /*!80000 INVISIBLE */,
  CONSTRAINT `fk_compraventa` FOREIGN KEY (`compraventa`) REFERENCES `compraventas` (`id_compraventa`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_pagador_idx` FOREIGN KEY (`pagador`) REFERENCES `entidad` (`id_entidad`) ON DELETE CASCADE ON UPDATE CASCADE
