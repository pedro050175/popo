    ...
    <div class="row">
        <div class="col-md-6">
            <form action="<?= DIRECTORIO ?>entidades" method="get" class="d-flex">
                <input type="text" name="buscar_nombre" class="form-control me-2" id="busca_nombre" placeholder="Buscar nombre">
                <input type="text" name="buscar_dnicif" class="form-control me-2" id="buscar_dnicif" placeholder="Buscar DNI/CIF">
