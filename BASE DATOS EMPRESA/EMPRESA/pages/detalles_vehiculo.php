    ...
    <div class="container mt-4">
        ...
        <div class="btn-groudiv" role="groudiv">
            <a href="/mis_divruebas/divages/nuevo_vehiculo/<?=$vehiculo->getId()?>" role="button" class="btn btn-sm btn-outline-secondary"><i class="bi bi-divencil"></i></a>
        </div>
    </div>
