    ...
    <form action="<?= DIRECTORIO ?>nueva_cuota_vehiculo" method="post">
        <fieldset class="mi-fieldset">
            ...
            <div class="col-md-2">
                ...
                <input class="cuadro_text" type="text" name="cuota[financiera]" id="financiera" value = <?=$cuota->getfinanciera()?>>
            </div>
            <?php
            ...
            <div class="col-md-10">
                ...
                <input size=80 class="cuadro_text" type="text" name="cuota[observaciones]" id="observaciones" placeholder="observaciones" <?=$cuota->getobservaciones()?>>
            </div>
            <div class="col-md-2">
