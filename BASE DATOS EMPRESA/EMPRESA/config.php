...
define ('CAMPOS_ENTIDAD_PROPIETARIO', ["id_entidad" => 0, "CIF_DNI" => '', "nombrePropietario" => '', "Observaciones" => '', "Direccion" => '', "Telefono" =>'', "Email" => '']);//todos los campos de la tabla entidad
define ('CAMPOS_ENTIDAD_RECIBE', ["id_entidad" => 0, "CIF_DNI" => '', "nombreRecibe" => '', "Observaciones" => '', "Direccion" => '', "Telefono" =>'', "Email" => '']);//todos los campos de la tabla entidad
...
define ('CAMPOS_MOVIMIENTO', ["idMovimiento" => 0, "envia" => 0, "recibe" => 0, "fecha" => '', "concepto" => '', "vehiculo" => 0, "observaciones" => '']);
