...
// esto se usa para el borrar entidad con fetch de javaS Router::add('DELETE', '/pages/nueva_entidad/:id', function($entidadId){return (new EntidadController())->delete($entidadId);});
