...
class Router {
    ...
    public static function dispatch ():void{
        ...
        $param = null;
        preg_match('/[0-9]+$/', $action, $match);//busca la expresion regular (numeros uno o mas veces que se repiten hasta el final) en action y lo que en coincida con la empresion lo guarda en match
